...
async function updateSession(request: NextRequest) {
  ...
  // Refresh session if expired and retrieve current user
  const {
    data: { user },
  ...
  // Protected route validation — only /dashboard is protected
  ...
  // Redirect already authenticated users trying to access login/signup pages
...
export const config = {
  matcher: [
     ...
     * - Image and media assets (.png, .jpg, .svg, etc.)
     */
